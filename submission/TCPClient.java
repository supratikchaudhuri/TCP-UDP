...
/**
 * TCP Client Class. This class handles clients request by allowing chossing various operations and relaying them to the server.
...
class TCPClient {
  ...
  public static void main(String[] args) throws Exception {
    try {
      ...
      System.out.println(start + " TCP Client started on port " + s.getPort());
